...
import { FundingSearchParameter, ReportCoverage } from '@modules/report/models';
import { ReportService } from '@modules/report/services';
import swal from 'sweetalert2';

@Component({
    selector: 'sb-coverage',
...
export class CoverageComponent implements OnInit {
    ...
    submitForm() {
        ...
        this.reportService.findCoverage(param).subscribe((result: ReportCoverage[]) => {
            this.items = result;
            swal.close();
        });
    }
